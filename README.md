...
3. requirements untuk OCR (ini adalah Python package yang harus di-install via pip.)
    * paddleocr==2.7.3
    * paddlepaddle==2.6.2
    * pdf2image==1.17.0
    * pillow==10.4.0
...
Gunakan opsi ini jika tim membutuhkan alur parity report berbasis script. abaikan jika Opsi 1 sudah berhasil, dan langsung menuju ke langkah 7
